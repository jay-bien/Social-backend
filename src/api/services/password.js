...
var Password = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        buffer = _a.sent();
                        return [2 /*return*/, buffer.toString('hex') + "." + salt];
                    case 2:
                        e_1 = _a.sent();
                        return [3 /*break*/, 3];
    ...
    Password.compare = function (password, storedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, hashedPassword, salt, buffer;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        buffer = _b.sent();
                        return [2 /*return*/, buffer.toString('hex') === hashedPassword];
                }
            });
        });
    };
